...
(function() {
	...
	// "On Visible" animations.
		...
		onvisible.add('#text03', { style: 'tilt-right', speed: 750, intensity: 8, delay: 0, state: true, replay: false });
		onvisible.add('#text04', { style: 'tilt-right', speed: 2000, intensity: 4, delay: 0, state: true, replay: false });
		...
		onvisible.add('#icons01', { style: 'slide-left', speed: 1000, intensity: 5, delay: 0, state: true, replay: false });
		onvisible.add('#video03', { style: 'fade-down', speed: 1000, intensity: 5, delay: 0, state: true, replay: false });
